  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full relative overflow-hidden flex flex-col items-center justify-center min-h-[85vh] px-4">
        ...
        <div className="absolute top-0 inset-x-0 h-[500px] bg-gradient-to-b from-orange-100/50 dark:from-orange-900/20 to-transparent pointer-events-none" />
        ...
        <div className="z-10 max-w-5xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="inline-flex items-center rounded-full border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/30 px-3 py-1 text-sm font-medium text-orange-600 dark:text-orange-400 mb-4 transition-transform hover:scale-105">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="#features">
              <Button size="lg" variant="outline" className="h-14 px-8 text-base rounded-full font-medium border-border hover:bg-muted transition-colors">
                Explore Features
              </Button>
            </Link>
          </div>
        ...
        <div className="w-full max-w-6xl mx-auto mt-20 relative z-20 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
          <div className="rounded-2xl border border-border/60 bg-card/50 backdrop-blur-xl shadow-2xl overflow-hidden">
            <div className="h-12 border-b border-border/60 flex items-center px-4 gap-2 bg-muted/50">
              <div className="w-3 h-3 rounded-full bg-red-400"></div>
              <div className="w-3 h-3 rounded-full bg-amber-400"></div>
              <div className="w-3 h-3 rounded-full bg-green-400"></div>
              <div className="mx-auto bg-background border border-border rounded-md h-6 w-1/3 flex items-center justify-center text-[10px] text-muted-foreground font-mono">
                template-builder.app
              </div>
            </div>
            <div className="aspect-[16/9] w-full bg-muted/80 relative overflow-hidden flex">
              {/* Fake Sidebar */}
              <div className="w-64 h-full border-r border-border bg-card p-4 space-y-4">
                <div className="h-8 w-24 bg-muted rounded-md"></div>
                <div className="space-y-2">
                  <div className="h-12 w-full bg-muted/50 rounded-md border border-border"></div>
                  <div className="h-12 w-full bg-muted/50 rounded-md border border-border"></div>
                  <div className="h-12 w-full bg-muted/50 rounded-md border border-border"></div>
                </div>
              </div>
              {/* Fake Canvas */}
              <div className="flex-1 h-full p-8 flex items-center justify-center bg-[radial-gradient(var(--border)_1px,transparent_1px)] [background-size:16px_16px]">
                <div className="w-full max-w-md bg-card shadow-xl rounded-lg overflow-hidden border border-border animate-pulse">
      ...
      {/* Features Showcase */}
      <section id="features" className="w-full py-24 bg-background relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">Everything you need to ship faster</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 rounded-2xl bg-orange-50/50 dark:bg-orange-900/10 border border-orange-100 dark:border-orange-900/30 hover:bg-orange-50 dark:hover:bg-orange-900/20 hover:border-orange-200 dark:hover:border-orange-800/50 transition-all hover:shadow-xl hover:shadow-orange-100/50 dark:hover:shadow-orange-900/20">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Drag & Drop Editor</h3>
              <p className="text-muted-foreground leading-relaxed">
                Build complex layouts effortlessly with our intuitive dnd-kit powered editor. No coding required.
              </p>
            </div>

            <div className="group p-8 rounded-2xl bg-muted/50 border border-border hover:bg-muted hover:border-border/80 transition-all hover:shadow-xl hover:shadow-muted/50">
              <div className="w-12 h-12 rounded-xl bg-muted text-muted-foreground flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Paintbrush strokeWidth={1.5} />
              </div>
              <h3 className="text-xl font-bold text-foreground mb-3">Shadcn Variable Injection</h3>
              <p className="text-muted-foreground leading-relaxed">
                Paste your custom Shadcn CSS variables directly into the editor and see your brand come to life instantly.
              </p>
            </div>

            <div className="group p-8 rounded-2xl bg-amber-50/50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 hover:bg-amber-50 dark:hover:bg-amber-900/20 hover:border-amber-200 dark:hover:border-amber-800/50 transition-all hover:shadow-xl hover:shadow-amber-100/50 dark:hover:shadow-amber-900/20">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">Instant HTML Export</h3>
              <p className="text-muted-foreground leading-relaxed">
